...
import com.zen.the_fog.client.models.TheManSpitModel;
...
public class TheManSpitRenderer extends EntityRenderer<TheManSpitEntity> {
    ...
    public static final Identifier TEXTURE = new Identifier(ManFromTheFog.MOD_ID,"textures/particle/the_man_spit.png");
